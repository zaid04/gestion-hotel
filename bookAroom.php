...
if($days <= 0){
  $msg = 'Chambre disponible';
}else{
   $msg =  'Chambre disponible a partir de:'.$_POST['arrival']. ' jusqua: ' .$_POST['departure'];
...
// filtering the rooms
 // ======================================================================================================
             ...
             if($status=='Confirmed'){
                $btn =  '<div style="margin-top:10px; color: rgba(0,0,0,1); font-size:16px;"><strong>Réservé!</strong></div>';
                 $img_title = ' 
                 ...
                 <div class="form-group">
                        <div class="row">
                          <div class="col-xs-12 col-sm-12">
                            <input type="submit" class="button rooms_button"  id="booknow" name="booknow" onclick="return validateBook();" value="Réserver maintanant!"/>
                    ...
                    $img_title = ' 
                           ...
                           <figcaption class="img-title">
                                ...
                                '.$result->ACCOMDESC . '<br/>  
                                Nombre de personne:' . $result->NUMPERSON .' <br/> 
                                Prix:'.$result->PRICE.'</h5>    
                            </figcaption>
                ...
                $btn =  '
                 <div class="form-group">
                        <div class="row">
                          <div class="col-xs-12 col-sm-12">
                            <input type="submit" class="button rooms_button"  id="booknow" name="booknow" onclick="return validateBook();" value="Réserver maintenant!"/>
                          ...
                          <div class="rooms_list">
                            <ul>
                              <li class="d-flex flex-row align-items-center justify-content-start">
                                ...
                                <span>Nombre de personne - <?php echo $result->NUMPERSON ;?></span>
                              </li> 
                              <li class="d-flex flex-row align-items-center justify-content-start">
                                <img src="images/check.png" alt="">
                                <span>Chambre restantes :<?php echo  $resNum ;?></span>
                              </li>
                            </ul>
                          </div>
                          <div class="rooms_price"><?php echo   $result->PRICE ;?>dh/<span>Nuit</span></div>
                           <?php echo $btn ; ?> 
                        </div>
                      </div>
