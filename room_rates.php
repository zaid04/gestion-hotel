...
if($days <= 0){
  $msg = 'Les chambres disponibles aujourdhui';
}else{
   $msg =  'les chambres disponibles a partire de :'.$_POST['arrival']. ' jusqua: ' .$_POST['departure'];
                          ...
                          <div class="rooms_list">
                            <ul>
                              <li class="d-flex flex-row align-items-center justify-content-start">
                                ...
                                <span>Nombre de personnes - <?php echo $result->NUMPERSON ;?></span>
                              </li> 
                              <li class="d-flex flex-row align-items-center justify-content-start">
                                <img src="images/check.png" alt="">
                                <span>Les chambres restantes :<?php echo  $resNum;?></span>
                              </li>
                            </ul>
                          </div>
