...
<form  method="post" action="processreservation.php?action=delete">
	<table id="table" class="table table-striped" border="1px" cellspacing="0">
<thead>
<tr>
<td width="5%">#</td>	

<td width="90"><strong>Utilisateur</strong></td>
<!--<td width="10"><strong>Confirmation</strong></td>-->
<td width="80"><strong>Date du transaction</strong></td>
<td width="80"><strong>Code de confirmation</strong></td>
<td width="70"><strong>Total des chambres</strong></td>
<td width="80"><strong>Prix total</strong></td>
						...
						<div class="modal-body">
								...
								<div id="display">
										...
										<p>ID : <div id="infoid"></div></p><br/>
											Nom : <div id="infoname"></div><br/>
											Email Address : <div id="Email"></div><br/>
											Genre : <div id="Gender"></div><br/>
											date de naissance : <div id="bday"></div>
										</p>
