 ...
 <div class="col-lg-3">  
          <div class="box box-solid">
            <div class="box-header with-border">
              <h3 class="box-title ">Information d'utilisateur</h3><hr/>
            </div>
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li class="active"><a><i class="fa fa-inbox"></i> Nom :
                  <span class="pull-right"><?php echo $res->G_FNAME; ?></span></a></li>
                <li class="active"><a><i class="fa fa-envelope-o"></i> Prenom :
                <span class="pull-right"><?php echo $res->G_LNAME; ?></span></a></li>
                <li class="active"><a><i class="fa fa-file-text-o"></i> Adresse : <br/>
...
?>
        ...
        <div class="row">
            ...
            <ul class="nav nav-pills nav-stacked">
                ...
                <p><strong>Date d'arrivée: </strong><?php echo date_format(date_create($cur->ARRIVAL),'m/d/Y');?></p>
                <p><strong>Date de départ: </strong><?php echo date_format(date_create($cur->DEPARTURE),'m/d/Y'); ?></p>
                <p><strong>Nuit(s): </strong><?php echo ($day==0) ? '1' : $day; ?></p>
                <p><strong>Prix: </strong>$<?php echo $cur->RPRICE; ?></p>
