...
<form class="form-horizontal" action="" method="post" onsubmit="return personalInfo()" name="personal" >
    ...
    <br/>
     ...
     <div><h2>Information d'Utilisateur</h2></div>
     ...
     <div><h2>Details de reservation</h2></div>
     <?php
$code = $_GET['code'];
...
<!-- 3f84uq -->
                    ...
                    <div class="form-group">
                      <div class="col-md-10">
                        <label class="col-md-4 control-label" for=
                        "TRANSDATE">Date du transaction:</label>
                        <div class="col-md-8">
                    ...
                    <div class="form-group">
                      <div class="col-md-10">
                        <label class="col-md-4 control-label" for=
                        "CONFIRMATIONCODE">Code de confirmation:</label>
