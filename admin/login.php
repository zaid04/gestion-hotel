...
if (isset($_POST['btnlogin'])) {
    ...
    if ($uname == '' OR $upass == '') {
?>    <script type="text/javascript">
                alert("Nom d'utilisateur et mot de passe incorrecte");
                </script>
            <?php
...
?>    <script type="text/javascript">
                alert("Nom d'utilisateur et mot de passe sont invalides..");
                window.location = "index.php";
                </script>
        <?php
        }
                        ...
                        <form role="form" method="POST" action="login.php">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Nom d'utilisateur" name="email" type="text" autofocus>
                                </div>
                                <div class="form-group">
                                ...
                                <button type="submit"  name="btnlogin" class="btn btn-lg btn-success btn-block">Connecter</button>
                            </fieldset>
                        </form>
                    </div>
                </div>
