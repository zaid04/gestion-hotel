...
<link href="<?php echo WEB_ROOT; ?>admin/css/bootstrap.min.css?v=" rel="stylesheet">
<link href="<?php echo WEB_ROOT; ?>admin/css/dataTables.bootstrap.css?v=" rel="stylesheet" media="screen">
...
$(document).ready(function() {
    ...
    <link href="<?php echo WEB_ROOT; ?>admin/css/offcanvas.css?v=<?php echo time(); ?>" rel="stylesheet">
<?php
	      ...
	      <div class="container">
	        ...
	        <div class="collapse navbar-collapse">
	          <ul class="nav navbar-nav">
	            <li class="<?php echo (currentpage() == 'index.php') ? "active" : false;?>"><a href="<?php echo WEB_ROOT; ?>admin/index.php" >Acceuil</a></li>
	            <li class="<?php echo (currentpage() == 'mod_room') ? "active" : false;?>"><a href="<?php echo WEB_ROOT; ?>admin/mod_room/index.php">Chambres</a></li>
	            ...
	            <?php if($_SESSION['ADMIN_UROLE']=="Administrator"){ ?>
	             <li class="<?php echo (currentpage() == 'mod_users') ? "active" : false;?>"><a href="<?php echo WEB_ROOT; ?>admin/mod_users/index.php" >Utilisateurs</a></li>
	             <?php } ?>
	            <li class="<?php echo (currentpage() == 'logout.php') ? "active" : false;?>"><a class="toggle-modal" href="#logout">Se deconnecter</a></li>
	          </ul>
