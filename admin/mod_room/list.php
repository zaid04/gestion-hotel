	...
	<?php
		...
		<!-- <div class="panel panel-primary"> -->
			...
			<h3 align="left">List of Rooms</h3>
				...
				<table id="example" style="font-size:12px" border="1px" class="table table-striped table-hover table-responsive"  cellspacing="0">
				  ...
				  <thead>
				  	...
				  	<th>No.</th>
				  		...
				  		Image</th>
				  		<!-- <th>Room#</th> -->
				  		<th align="left"  width="200">Chambre</th>	
				  		<!-- <th align="left" width="120">Description</th> -->
				  		<th align="left" width="120">Accomodation</th> 
				  		<th align="left" width="90">Personne</th>
				  		<th align="left"  width="200">Prix</th>
				  		<!-- <th># of Rooms</th> -->
				  	</tr>	
				  </thead>
				  <tbody>
				...
				<div class="btn-group">
				  <a href="index.php?view=add" class="btn btn-default">Nouveau</a>
				  <button type="submit" class="btn btn-default" name="delete"><span class="glyphicon glyphicon-trash"></span> Supprimer</button>
				</div>
				</form>
