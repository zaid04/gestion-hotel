		...
		<legend>Modifier chambre</legend>
              ...
              <div class="col-md-8">
                <input name="" type="hidden" value="">
                 ...
                 <input class="form-control input-sm" id="ROOM" name="ROOM" placeholder=
                    "Nom de chambre" type="text" value="<?php echo $result->ROOM; ?>">
              </div>
            </div>
          </div>
            ...
            <div class="col-md-8">
              ...
              <div class="col-md-8">
                <input class="form-control input-sm" id="NUMPERSON" name="NUMPERSON" placeholder=
                    "Nombre de peersonne" type="text" value="<?php echo $result->NUMPERSON; ?>" onkeyup="javascript:checkNumber(this);">
              </div>
            </div>
          </div>
              ...
              <div class="col-md-8">
                <input name="" type="hidden" value=""> -->
                 <input class="form-control input-sm" id="ROOMNUM" name="ROOMNUM" placeholder=
                    "Chambre #" type="hidden" value="<?php echo $result->ROOMNUM; ?>">
           <!--    </div>
            </div>
          </div>
         -->
         <div class="form-group">
            <div class="col-md-8">
              ...
              <div class="col-md-8">
              <input type="file" name="image" value="<?php echo $result->ROOMIMAGE; ?>" id="image">
              </div>
            </div>
          </div>
