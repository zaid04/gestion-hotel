                        ...
                        <div class="panel panel-success">
                            ...
                            <div class="panel-body"> 
                              ...
                              <table>
                                ...
                                <tr>
                                  <td colspan="2"></td>
                                  <td><button id="btnResetPassword" class="btnResetPass btn btn-primary">Changer mot de passe</button></td>
                                </tr>
                                <tr>
                                  <td></td>
                                  <td></td>
                                ...
                                <form role="form" method="POST" action="">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            <input class="form-control" placeholder="Entrer vot nom d utilisateur" id="email"name="email" type="text" autofocus>
                                        </div>  
                                        <button type="button"   name="btnlogin" class="checkusername btn-lg btn-success btn-block">Continuer</button>
                                    </fieldset>
                                </form>
                            </div>
                        </div>
