    ...
    <section class="invoice">
      ...
      <div class="row invoice-info">
        ...
        <br/>
          ...
          <br> -->
          <b>ID de confirmation: </b> <p style="background-color:blue;color:white"> <?php echo $result->CONFIRMATIONCODE; ?></p> 
          <input type="hidden" name="code" value="<?php echo $result->CONFIRMATIONCODE; ?>">
<br>
          <b>Date du transaction:</b> <?php echo  Date($result->TRANSDATE); ?>
<br>
          <b>Compte:</b> <?php echo $result->GUESTID; ?>
     ...
     ?>
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          ...
          <button type="submit"  ><i class="fa fa-print"></i> Imprimer</button>
