    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i class="fa fa-globe"></i> Fkih Ben Saleh
      ...
      <div class="row invoice-info">
        <div class="col-sm-4 invoice-col">
          De 
          <address>
            <strong>Fkih ben saleh</strong><br>
            2021 est,2022<br>
            Maroc<br>
            Phone: 06066976123<br>
            Email: zaidmohamed411@gmail.com
          </address>
        </div>
        <!-- /.col -->
        <div class="col-sm-4 invoice-col">
        ...
        <br/>
          ...
          <br> -->
          <b>ID confirmation:</b> <p style="background-color:blue;color:white"> <?php echo $res->CONFIRMATIONCODE; ?></p> 
          <input type="hidden" name="code" value="<?php echo $res->CONFIRMATIONCODE; ?>">
<br>
          <b>Date de transaction:</b> <?php echo  Date($res->TRANSDATE); ?>
<br>
          <b>Compte:</b> <?php echo $res->GUESTID; ?>
        ...
        <div class="col-xs-12 table-responsive">
          ...
          $days =  dateDiff(date($result->ARRIVAL),date($result->DEPARTURE));
            ...
            <tr> 
              ...
              <td><?php echo $result->ROOMDESC . ' <br/> Personne: ' .  $result->NUMPERSON;?></td>
              <td> dh <?php echo $result->PRICE;?></td>
              ...
              <td> dh <?php echo $result->RPRICE;?></td>
            </tr>
