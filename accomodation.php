...
if($days <= 0){
  $msg = 'Chambre disponible aujourdui';
}else{
...
<div id="bread">
   <ol class="breadcrumb">
      <li><a href="<?php echo WEB_ROOT ;?>index.php">Acceuil</a>
      </li>
...
// filtering the rooms
 // ======================================================================================================
             ...
             if($status=='Confirmed'){
                ...
                $btn =  '<div style="margin-top:10px; color: rgba(0,0,0,1); font-size:16px;"><strong>Reservé!</strong></div>';
                 $img_title = ' 
                 ...
                 <div class="form-group">
                        <div class="row">
                          <div class="col-xs-12 col-sm-12">
                            <input type="submit" class="btn dragonhouse-btn  btn-primary btn-sm" id="booknow" name="booknow" onclick="return validateBook();" value="Réserver maintenant!"/>
                  ...
                  <div id="roomimg" class="col-md-4 img-portfolio">
                    ...
                    <a href="#" >
                      ...
                      <div class="descRoom">
                        ...
                        <li>Nombre de personne: <?php echo $result->NUMPERSON ;?></li>
                         <li>Chambre restantes :<?php echo  $resNum ;?></li>   
