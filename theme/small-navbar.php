      ...
      <div class="sm-ul navbar-custom-menu ">
          ...
          <li class="dropdown messages-menu">
            ...
            <ul class="dropdown-menu">
              <li class="header">Vous avez <?php echo $msgCnt['MSG'] ; ?> messages</li>
              <?php 
                ...
                <ul class="">
                  <li> 
                    <a  class="read" href="<?php echo WEB_ROOT ;  ?>guest/readmessage.php?code=<?php echo  $row['CONFIRMATIONCODE']; ?>" data-toggle="lightbox"   data-id="<?php echo  $row['CONFIRMATIONCODE']; ?> " >
                      ...
                      <p>Reservation en cours<?php echo   $row['STATUS']; ?>.. </p> 
                    </a>
                  </li>
                </ul>
              </li> 
            ...
            <li class="widget-user-header bg-yellow">
              ...
              <h3 class="widget-user-username"><?php echo $_SESSION['name']. ' ' . $_SESSION['last']; ?> </h3> 
                ...
                <li><a style="color:#000;text-align:left;border-bottom:1px solid #fff;"
                    href="<?php echo WEB_ROOT ;  ?>guest/profile.php" data-toggle="lightbox" >Compte </a></li> 
                <li><a style="color:#000;text-align:left;border-bottom:1px solid #fff;" 
                href="<?php echo WEB_ROOT ;  ?>guest/bookinglist.php" data-toggle="lightbox">Réservation </a></li>
                <li><a style="color:#000;text-align:left;border-bottom:1px solid #fff;" href="<?php echo WEB_ROOT.'logout.php';  ?>">Déconnection </a></li> 
            </ul>

          </li>
          <?php }else { ?>
            <li><a     data-target="#LoginModal" data-toggle="modal"  title="Login Guest"  href="">se connecter
             </a>
             </li>
        <?php  } ?>
          </ul>
              ...
              <div class="modal-content">
                ...
                <form action="" method="post"> 
                  ...
                  <div class="modal-footer">  
                         <button type="button" name="btnLogin" class="btnLoginModal button">se connecter</button> 
                  </div>  
                 </form>  
              </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->
