...
<link rel="stylesheet" type="text/css" href="<?php echo WEB_ROOT;?>styles/main_styles.css?v=<?php echo time(); ?>">
<link rel="stylesheet" type="text/css" href="<?php echo WEB_ROOT;?>styles/responsive.css?v=<?php echo time(); ?>">
<link rel="stylesheet" type="text/css" href="<?php echo WEB_ROOT;?>styles/custom-navbar.css?v=<?php echo time(); ?>">
<link rel="stylesheet" type="text/css" href="<?php echo WEB_ROOT;?>styles/bootstrap.css?v=<?php echo time(); ?>">
...
<div class="super_container">
  <header class="header">
    <div class="header_content d-flex flex-column align-items-center justify-content-lg-end justify-content-center">
      ...
      <!-- Logo -->
      <div class="logo"><a href="#"><img class="logo_1" src="<?php echo WEB_ROOT;?>images/image.png" alt=""><img class="logo_2" src="<?php echo WEB_ROOT;?>images/" alt=""><img class="logo_3" src="<?php echo WEB_ROOT;?>images/" alt=""></a></div>

      <!-- Main Nav -->
      <nav class="main_nav">
        <ul class="d-flex flex-row align-items-center justify-content-start">
           <li><a href="<?php echo WEB_ROOT;?>index.php">Acceuil</a></li>
          <li><a href="<?php echo WEB_ROOT;?>index.php?p=about">A propos</a></li>
          <li><a href="<?php echo WEB_ROOT;?>index.php?p=rooms">Chambres</a></li> 
...
<!--         <div class="search_button">
      ...
      <div class="search_panel">
        <div class="search_panel_content d-flex flex-row align-items-center justify-content-start">
          ...
          <form action="#" class="search_form">
            <input type="text" class="search_input" placeholder="Taper ici" required="required">
          </form>
  ...
  <div class="menu">
    <div class="menu_container d-flex flex-column align-items-center justify-content-center">
      ...
      <div class="button menu_button"><a href="room_rates.php">Réserver maintenant</a></div>
  ...
  <div class="home">
    ...
    <div class="home_container d-flex flex-column align-items-center justify-content-center">
      <div class="home_title"><h1>Réserver votre place</h1></div>
      <div class="home_text text-center">Bienvenue dans le merveilleux hotel du monde,magnifique place pour passer les vacances.</div>
            ...
            <form action="<?php echo WEB_ROOT;?>index.php?p=booking" method="POST" class="booking_form" autocomplete="off">
              <div class="booking_form_container d-flex flex-lg-row flex-column align-items-start justify-content-start flex-wrap">
                <div class="booking_form_inputs d-flex flex-row align-items-start justify-content-between flex-wrap">
                  <div class="booking_dropdown"><input type="text" class="datepicker booking_input booking_input_a booking_in" placeholder="Date d'entrée" name="arrival" required="required" value="<?php echo isset($_POST['arrival']) ? $_POST['arrival'] :date('m/d/Y');?>"></div>
                  <div class="booking_dropdown"><input type="text" class="datepicker booking_input booking_input_a booking_out" placeholder="Date de sortie" name="departure" required="required" value="<?php echo isset($_POST['departure']) ? $_POST['departure'] : date('m/d/Y');?>" ></div>
                ...
                <button class="booking_form_button ml-lg-auto">réserver maintenant</button>
              </div>
            </form>
          </div>
        </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-4 footer_col">
                <div class="footer_info d-flex flex-column align-items-center justify-content-start">
                  <div class="text-center">
                    <div>Address:</div>
                    <div>el jadida,fkih ben saleh </div>
                  </div>
                </div>
              </div>
              <div class="col-lg-4 footer_col">
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made  by <a href="#" target="_blank">Zaid&Ayman</a>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title" id="myModalLabel">Choisir image.</h4>
                </div>
                ...
                "post">
                  ...
                  <div class="modal-footer">
                    ...
                    name="savephoto" type="submit">Télécharger image</button>
                  </div>
                </form>
              </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->
