...
<script type="text/javascript"> alert("Votre reservation est placée directement!");</script>
...
<div id="bread">
   <ol class="breadcrumb">
      ...
      <li><a href="<?php echo WEB_ROOT ;?>booking/">Carte</a></li>  
       <li class="active">Détails de réservation</li>
   </ol> 
</div> 
  ...
  <div class="row">
   ...
   echo $count_cart;
    ...
    <div class="col-md-4 col-sm-2">
      <div class="col-md-12">
        <label>Date du transaction:</label>
       <?php echo date("m/d/Y") ; ?>
      </div>
       <div class="col-md-12">
...
?>
        ...
        <tr>
          ...
          <td><?php echo  ' Dh '. $result->PRICE; ?></td>
          <td><?php echo   $_SESSION['dragonhouse_cart'][$i]['dragonhouseday']; ?></td>
          <td><?php echo ' Dh '.   $_SESSION['dragonhouse_cart'][$i]['dragonhouseroomprice']; ?></td>
        </tr>
<?php
 ...
 ?> 
    ...
    <div class="right"> 
      <h3 style="text-align: right;">Total: dh  <?php echo   $_SESSION['pay'] ;?></h3>
    </div>
    <br>
    <div class="">
       <button type="submit" class="button"  name="btnsubmitbooking">Continer reservation </button>
    </div>
  </div>   
</form>
