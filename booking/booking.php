  ...
  <div id="accom-title"  > 
    <div  class="pagetitle">   
                    ...
                    $query = "SELECT * FROM `tblroom` r ,`tblaccomodation` a WHERE r.`ACCOMID`=a.`ACCOMID` AND ROOMID=" . $_SESSION['dragonhouse_cart'][$i]['dragonhouseroomid'];
                     ...
                     $cur = $mydb->loadResultList(); 
                      foreach ($cur as $result) { 
                        ...
                        echo '</td>';
                        echo '<td>dh <output id="TotAmount'.$_SESSION['dragonhouse_cart'][$i]['dragonhouseroomid'].'" >'.$_SESSION['dragonhouse_cart'][$i]['dragonhouseroomprice'].'</output></td>';
                        echo '<td ><a href="index.php?view=processcart&id='.$result->ROOMID.'">supprimer</td>';
          ...
          <tfoot>
           ...
           <td colspan="4">
             <h4><b>dh <span id="sum"><?php  echo isset($_SESSION['pay']) ?  $_SESSION['pay'] :'votre carte est vide.';?></span></b></h4>
        ...
        <form method="post" action="">
             ...
             if (isset($_SESSION['dragonhouse_cart'])){
              ?> 
                 <button type="submit" class="button "name="clear">Annuler</button> 
             <?php
             
              if (isset($_SESSION['GUESTID'])){
                ?>
                <div  class="button " ><a href="<?php echo WEB_ROOT; ?>booking/index.php?view=payment" name="continue">Continuer</a></div>
               <?php 
              }else{ ?>
                 <div  class="button " ><a href="<?php echo WEB_ROOT; ?>booking/index.php?view=logininfo"  name="continue">Continuer</a></div>
             <?php
              }
            }
